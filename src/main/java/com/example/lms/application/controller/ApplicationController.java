...
public class ApplicationController {
    ...
    // 수강신청 목록 보기
    @GetMapping
    public LmsResponse<List<ApplicationResponse>> getList(@RequestHeader(value = "member-id",required = false) String memberId, @RequestHeader(value = "role",required = false)String role, @RequestHeader(value = "name",required = false)String name){
